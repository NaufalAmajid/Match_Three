...
public class TileController : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        else
        {
            ...
            {   
                ...
                //jika tidak adjacent maka ubah yang dipilih
                else
                {
                    previousSelected.Deselect();
    ...
    public IEnumerator MoveTilePosition(Vector2 targetPosition, System.Action onCompleted)
    {
        ...
        //memberi animasi untuk frame selanjutnya
    ...
    public List<TileController> GetAllMatches()
    {
        ...
        // mendapatkan kecocokan untuk horizontal dan vertikal
        ...
        //menambahkan tilenya yang cocok jika kecocokan ditemukan
